                    ...
                    <div
                        ...
                        <figure class="w-full md:w-80 shrink-0">
                            <img src="https://images.unsplash.com/photo-1580587771525-78b9dba3b914?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
                                alt="Casa moderna" class="h-full w-full object-cover">
                        ...
                        <div class="card-body">
                            <div class="flex justify-between items-start">
                                ...
                                <div class="text-2xl font-bold text-primary">R$ 850.000</div>
                            </div>
                            ...
                            <div class="card-actions justify-between items-center">
                                ...
                                <a href="detalhes.html" class="btn btn-primary">
                    ...
                    <div
                        ...
                        <figure class="w-full md:w-80 shrink-0">
                            <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
                                alt="Apartamento luxuoso" class="h-full w-full object-cover">
                        </figure>
                        <div class="card-body">
                            <div class="flex justify-between items-start">
                                <div>
                                ...
                                <div class="text-2xl font-bold text-primary">R$ 1.250.000</div>
                            </div>
                    ...
                    <div
                        ...
                        <figure class="w-full md:w-80 shrink-0">
                            <img src="https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
                                alt="Casa com piscina" class="h-full w-full object-cover">
                        ...
                        <div class="card-body">
                            <div class="flex justify-between items-start">
                                ...
                                <div class="text-2xl font-bold text-primary">R$ 2.500.000</div>
                            </div>
